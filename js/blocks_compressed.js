...
Blockly.Blocks.aerobot_move = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.AEROBOT_HELPURL); this.setColour(Blockly.Blocks.aerobot.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.aerobot.image, 64, 64)).appendField(Blockly.Msg.AEROBOT_MOVE_TITLE).appendField(new Blockly.FieldDropdown([[Blockly.Msg.AEROBOT_FORWARD, "forward"], [Blockly.Msg.AEROBOT_BACKWARD, "backward"], [Blockly.Msg.AEROBOT_STOP, "stop"], [Blockly.Msg.AEROBOT_TURN_LEFT, "cw"], [Blockly.Msg.AEROBOT_TURN_RIGHT, "ccw"]]),
            "DIRECTION"); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip(Blockly.Msg.AEROBOT_MOVE_TOOLTIP)
...
Blockly.Blocks.aerobot_lightsens = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.AEROBOT_HELPURL); this.setColour(Blockly.Blocks.aerobot.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.aerobot.image, 64, 64)).appendField(Blockly.Msg.AEROBOT_LIGHTSENS_TITLE).appendField(new Blockly.FieldDropdown([[Blockly.Msg.AEROBOT_CENTER, "CENTER"], [Blockly.Msg.AEROBOT_RIGHT, "RIGHT"], [Blockly.Msg.AEROBOT_LEFT, "LEFT"]]), "SENS"); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null);
        this.setTooltip(Blockly.Msg.AEROBOT_LIGHTSENS_TOOLTIP)
    }, onchange: function () { this.workspace && (Blockly.Blocks.aerobot.checkBlocks(this) ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.AEROBOT_WARNING)) }
};
Blockly.Blocks.aerobot_distsens = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.AEROBOT_HELPURL); this.setColour(Blockly.Blocks.aerobot.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.aerobot.image, 64, 64)).appendField(Blockly.Msg.AEROBOT_DISTSENS_TITLE).appendField(new Blockly.FieldDropdown([[Blockly.Msg.AEROBOT_CENTER, "CENTER"], [Blockly.Msg.AEROBOT_RIGHT, "RIGHT"], [Blockly.Msg.AEROBOT_LEFT, "LEFT"]]), "SENS"); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null);
        this.setTooltip(Blockly.Msg.AEROBOT_LIGHTSENS_TOOLTIP)
    }, onchange: function () { this.workspace && (Blockly.Blocks.aerobot.checkBlocks(this) ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.AEROBOT_WARNING)) }
};
Blockly.Blocks.aerobot_linesens = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.AEROBOT_HELPURL); this.setColour(Blockly.Blocks.aerobot.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.aerobot.image, 64, 64)).appendField(Blockly.Msg.AEROBOT_LINESENS_TITLE).appendField(new Blockly.FieldDropdown([[Blockly.Msg.AEROBOT_CENTER, "CENTER"], [Blockly.Msg.AEROBOT_RIGHT, "RIGHT"], [Blockly.Msg.AEROBOT_LEFT, "LEFT"], [Blockly.Msg.AEROBOT_NONE, "NONE"]]), "SENS"); this.setInputsInline(!0); this.setOutput(!0,
            "Number"); this.setTooltip(Blockly.Msg.AEROBOT_LINESENS_TOOLTIP)
    }, onchange: function () { this.workspace && (Blockly.Blocks.aerobot.checkBlocks(this) ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.AEROBOT_WARNING)) }
};
...
Blockly.Blocks.array_create_with = {
    ...
    }, decompose: function (a) { var b = Blockly.Block.obtain(a, "array_create_with_container"); b.initSvg(); for (var d = b.getInput("STACK").connection, c = 0; c < this.itemCount_; c++) { var e = Blockly.Block.obtain(a, "array_create_with_item"); e.initSvg(); d.connect(e.previousConnection); d = e.nextConnection } return b }, compose: function (a) {
        a = a.getInputTargetBlock("STACK"); for (var b = [], d = 0; a;)b[d] = a.valueConnection_, a = a.nextConnection && a.nextConnection.targetBlock(), d++; this.itemCount_ = d; this.updateShape_();
        for (d = 0; d < this.itemCount_; d++)b[d] && this.getInput("ADD" + d).connection.connect(b[d])
    }, saveConnections: function (a) { a = a.getInputTargetBlock("STACK"); for (var b = 0; a;) { var d = this.getInput("ADD" + b); a.valueConnection_ = d && d.connection.targetConnection; b++; a = a.nextConnection && a.nextConnection.targetBlock() } }, updateShape_: function () {
        if (this.getInput("EMPTY")) this.removeInput("EMPTY"); else for (var a = 0; this.getInput("ADD" + a);)this.removeInput("ADD" + a), a++; if (0 == this.itemCount_) this.appendDummyInput("EMPTY").appendField(Blockly.Msg.ARRAY_CREATE_EMPTY_TITLE);
        else for (a = 0; a < this.itemCount_; a++) { var b = this.appendValueInput("ADD" + a); 0 == a && b.appendField(Blockly.Msg.ARRAY_CREATE_WITH_INPUT_WITH) }
    }
}; Blockly.Blocks.array_create_with_item = { init: function () { this.setColour(Blockly.Blocks.array.HUE); this.appendDummyInput().appendField(Blockly.Msg.ARRAY_CREATE_WITH_ITEM_TITLE); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.ARRAY_CREATE_WITH_ITEM_TOOLTIP); this.contextMenu = !1 } };
...
Blockly.Blocks.array_getIndex = { init: function () { this.setHelpUrl(Blockly.Msg.ARRAY_GETINDEX); this.setColour(Blockly.Blocks.array.HUE); this.appendValueInput("ITEM").setCheck("Array").appendField(Blockly.Msg.ARRAY_GETINDEX_ITEM); this.appendValueInput("AT").setCheck("Number").appendField(Blockly.Msg.ARRAY_GETINDEX_AT); this.setInputsInline(!0); this.setOutput(!0); this.setTooltip(Blockly.Msg.ARRAY_GETINDEX_TOOLTIP) } }; Blockly.Blocks.base = {}; Blockly.Blocks.base_delay = { helpUrl: "http://arduino.cc/en/Reference/delay", init: function () { this.setColour(120); this.appendValueInput("DELAY_TIME", "Number").appendField("Delay").setCheck("Number"); this.setInputsInline(!0); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip("Delay specific time") } };
Blockly.Blocks.base_map = { helpUrl: "http://arduino.cc/en/Reference/map", init: function () { this.setColour(230); this.appendValueInput("NUM", "Number").appendField("Map ").setCheck("Number"); this.appendValueInput("DMAX", "Number").appendField("value to [0-").setCheck("Number"); this.appendDummyInput().appendField("]"); this.setInputsInline(!0); this.setOutput(!0); this.setTooltip("Re-maps a number from [0-1024] to another.") } }; Blockly.Blocks.blynk = {}; Blockly.Blocks.blynk.HUE = 65; Blockly.Blocks.blynk.image = filepath.media + "/blynk.png";
Blockly.Blocks.blynk_ethernet_begin = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.BLYNK_HELPURL); this.setColour(Blockly.Blocks.blynk.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.blynk.image, 64, 64)).appendField(Blockly.Msg.BLYNK_ETHERNET_BEGIN_TITLE).appendField(new Blockly.FieldDropdown([[Blockly.Msg.ETHERNET_VERSION_1, ""]], "VERSION")); this.appendValueInput("AUTH").setCheck("String").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.BLYNK_AUTH); this.appendValueInput("MAC_ADDRESS").setCheck("String").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.MAC_ADDRESS);
...
Blockly.Blocks.blynk_virtual_write = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.BLYNK_HELPURL); this.setColour(Blockly.Blocks.blynk.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.blynk.image, 64, 64)).appendField(Blockly.Msg.BLYNK_VIRTUAL_WRITE_TITLE); this.appendDummyInput().appendField("V").appendField(new Blockly.FieldTextInput("0"), "PIN"); this.appendValueInput("VALUE").setCheck("Number", "Boolean").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.VALUE); this.setInputsInline(!0);
...
Blockly.Blocks.blynk_email = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.BLYNK_HELPURL); this.setColour(Blockly.Blocks.blynk.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.blynk.image, 64, 64)).appendField(Blockly.Msg.BLYNK_EMAIL_TITLE); this.appendValueInput("ADDRESS").setCheck("String").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.EMAIL_ADDRESS); this.appendValueInput("TITLE").setCheck("String").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.EMAIL_TITLE);
...
Blockly.Blocks.blynk_connect = { init: function () { this.setHelpUrl(Blockly.Msg.BLYNK_HELPURL); this.setColour(Blockly.Blocks.blynk.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.blynk.image, 64, 64)).appendField(Blockly.Msg.BLYNK_CONNECT_TITLE); this.setOutput(!0); this.setTooltip(Blockly.Msg.BLYNK_CONNECT_TOOLTIP) } }; Blockly.Blocks.cast = {}; Blockly.Blocks.cast.HUE = 230;
Blockly.Blocks.cast_number = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.CAST_NUMBER_HELPURL); this.setColour(Blockly.Blocks.cast.HUE); this.appendDummyInput().appendField(Blockly.Msg.CAST_NUMBER_TITLE).appendField(new Blockly.FieldDropdown([[Blockly.Msg.VARIABLES_TYPE_NUMBER, "(int)"], [Blockly.Msg.VARIABLES_TYPE_UNSIGNED_INT, "(unsigned int)"], [Blockly.Msg.VARIABLES_TYPE_BYTE, "(byte)"], [Blockly.Msg.VARIABLES_TYPE_WORD, "(word)"], [Blockly.Msg.VARIABLES_TYPE_LONG, "(long)"], [Blockly.Msg.VARIABLES_TYPE_UNSIGNED_LONG,
            "(unsigned long)"], [Blockly.Msg.VARIABLES_TYPE_FLOAT, "(float)"], [Blockly.Msg.VARIABLES_TYPE_DOUBLE, "(double)"], [Blockly.Msg.VARIABLES_TYPE_CHAR, "(char)"]]), "TYPE"); this.appendValueInput("VAR").setCheck(profile.common.number_type).appendField(Blockly.Msg.VARIALBLE); this.setInputsInline(!0); this.setOutput(!0, profile.common.number_type); this.setTooltip(Blockly.Msg.CAST_NUMBER_TOOLTIP)
    }
...
}; Blockly.Blocks.dht = {}; Blockly.Blocks.dht.HUE = 215; Blockly.Blocks.dht.image = "../media/sensor/dht11.png";
Blockly.Blocks.dht_read = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.DHT_HELPURL); this.setColour(Blockly.Blocks.dht.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.dht.image, 64, 64)).appendField(Blockly.Msg.DHT_READ_SENSOR).appendField(new Blockly.FieldDropdown(profile["default"].dht), "SENSOR"); this.appendDummyInput().appendField(Blockly.Msg.DHT_READ_PIN).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN"); this.appendDummyInput().appendField(Blockly.Msg.DHT_READ_TYPE).appendField(new Blockly.FieldDropdown([[Blockly.Msg.DHT_READ_H,
            "h"], [Blockly.Msg.DHT_READ_C, "C"], [Blockly.Msg.DHT_READ_F, "F"]]), "TYPE"); this.setInputsInline(!0); this.setOutput(!0, "Number"); this.setTooltip(Blockly.Msg.DHT_READ_TOOLTIP)
    }, onchange: function () { this.workspace && this.setWarningText(Blockly.Msg.DHT_WARNING) }
}; 

Blockly.Blocks.gas = {}; Blockly.Blocks.gas.HUE = 215; Blockly.Blocks.gas.image = "../media/sensor/mq2.png";
Blockly.Blocks.gas_read = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.GAS_HELPURL); this.setColour(Blockly.Blocks.gas.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.gas.image, 64, 64)).appendField(Blockly.Msg.GAS_READ_SENSOR).appendField(new Blockly.FieldDropdown([["MQ2", "MQ2"], ["MQ7", "MQ7"]]), "SENSOR"); this.appendDummyInput().appendField(Blockly.Msg.GAS_READ_PIN).appendField(new Blockly.FieldDropdown(profile["default"].analog), "PIN"); this.appendDummyInput().appendField(Blockly.Msg.GAS_READ_TYPE).appendField(new Blockly.FieldDropdown([[Blockly.Msg.GAS_READ_SMOKE, "SMOKE"], [Blockly.Msg.GAS_READ_CO, "CO"], [Blockly.Msg.GAS_READ_LPG, "LPG"]]), "TYPE"); this.setInputsInline(!0); this.setOutput(!0, "Number"); this.setTooltip(Blockly.Msg.GAS_READ_TOOLTIP)
    }, onchange: function () { this.workspace && this.setWarningText(Blockly.Msg.GAS_WARNING) }
};

Blockly.Blocks.ldr = {}; Blockly.Blocks.ldr.HUE = 215; Blockly.Blocks.ldr.image = "../media/sensor/ldr.png";
Blockly.Blocks.ldr_read = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.LDR_HELPURL); this.setColour(Blockly.Blocks.ldr.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.ldr.image, 64, 64)).appendField(Blockly.Msg.LDR_READ_SENSOR); this.appendDummyInput().appendField(Blockly.Msg.LDR_READ_PIN).appendField(new Blockly.FieldDropdown(profile["default"].analog), "PIN"); this.setInputsInline(!0); this.setOutput(!0, "Number"); this.setTooltip(Blockly.Msg.LDR_READ_TOOLTIP)
    }, onchange: function () { this.workspace && this.setWarningText(Blockly.Msg.LDR_WARNING) }
};
...
Blockly.Blocks.ethernet_mac_address = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.ETHERNET_BEGIN_HELPURL); this.setColour(Blockly.Blocks.ethernet.HUE); this.appendDummyInput().appendField(new Blockly.FieldTextInput("DE"), "MAC_ADDRESS_1").appendField("-").appendField(new Blockly.FieldTextInput("AD"), "MAC_ADDRESS_2").appendField("-").appendField(new Blockly.FieldTextInput("BE"), "MAC_ADDRESS_3").appendField("-").appendField(new Blockly.FieldTextInput("EF"), "MAC_ADDRESS_4").appendField("-").appendField(new Blockly.FieldTextInput("FE"),
            "MAC_ADDRESS_5").appendField("-").appendField(new Blockly.FieldTextInput("ED"), "MAC_ADDRESS_6"); this.setInputsInline(!0); this.setOutput(!0, "String"); this.setTooltip(Blockly.Msg.ETHERNET_MAC_ADDRESS_TOOLTIP)
    }
}; Blockly.Blocks.ethernet_localip = { init: function () { this.setHelpUrl(Blockly.Msg.ETHERNET_LOCALIP_HELPURL); this.setColour(Blockly.Blocks.ethernet.HUE); this.appendDummyInput().appendField(Blockly.Msg.ETHERNET_LOCALIP_TITLE); this.setOutput(!0, "String"); this.setTooltip(Blockly.Msg.ETHERNET_LOCALIP_TOOLTIP) } };
...
}; Blockly.Blocks.grove = {}; Blockly.Blocks.grove.HUE = 190; Blockly.Blocks.grove.led_image = "../media/grove/grove_led.png"; Blockly.Blocks.grove.button_image = filepath.media + "/grove_button.jpg"; Blockly.Blocks.grove.touch_image = filepath.media + "/grove_touch.jpg"; Blockly.Blocks.grove.rotary_angle_image = filepath.media + "/grove_rotary_angle.jpg"; Blockly.Blocks.grove.relay_image = filepath.media + "/grove_relay.jpg"; Blockly.Blocks.grove.temperature_sensor_image = filepath.media + "/grove_temperature_sensor.jpg";
Blockly.Blocks.grove.light_sensor_image = "../media/grove/grove_light_sensor.png"; Blockly.Blocks.grove.rgb_lcd_image = "../media/grove_lcd_16x2.png"; Blockly.Blocks.grove.buzzer_image = filepath.media + "/grove_buzzer.jpg"; Blockly.Blocks.grove.sound_sensor_image = filepath.media + "/grove_sound_sensor.jpg"; Blockly.Blocks.grove.ir_receiver_image = filepath.media + "/grove_ir_receiver.jpg"; Blockly.Blocks.grove.ir_emitter_image = filepath.media + "/grove_ir_emitter.jpg";
Blockly.Blocks.grove.rgb_lcd_checkBlocks = function (a) {
    var b = null, d = a.type; a = a.workspace.getAllBlocks(); for (var c = 0; c < a.length; c++)if ("grove_rgb_lcd_setcolor" != a[c].type && "grove_rgb_lcd_print" != a[c].type && "grove_rgb_lcd_setcursor" != a[c].type && "grove_rgb_lcd_custom_setcursor" != a[c].type && "grove_rgb_lcd_clear" != a[c].type && "grove_rgb_lcd_scrolldisplayleft" != a[c].type && "grove_rgb_lcd_scrolldisplayright" != a[c].type && "grove_rgb_lcd_switch_scroll" != a[c].type && "grove_rgb_lcd_autoscroll" != a[c].type && "grove_rgb_lcd_noautoscroll" !=
...
Blockly.Blocks.grove_led = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.GROVE_LED_HELPURL); this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField(Blockly.Msg.GROVE_LED_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.grove.led_image, 64, 64)).appendField(Blockly.Msg.GROVE_PIN).appendField(new Blockly.FieldDropdown(profile["default"].grove_digital), "PIN").appendField(Blockly.Msg.GROVE_LED_STAT).appendField(new Blockly.FieldDropdown([[Blockly.Msg.INOUT_HIGH, "HIGH"], [Blockly.Msg.INOUT_LOW,
            "LOW"]]), "STAT"); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip(Blockly.Msg.GROVE_LED_TOOLTIP)
    }
};
Blockly.Blocks.grove_button = { init: function () { this.setHelpUrl(Blockly.Msg.GROVE_BUTTON_HELPURL); this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField(Blockly.Msg.GROVE_BUTTON_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.grove.button_image, 64, 64)).appendField(Blockly.Msg.GROVE_PIN).appendField(new Blockly.FieldDropdown(profile["default"].grove_digital), "PIN"); this.setOutput(!0, "Boolean"); this.setTooltip(Blockly.Msg.GROVE_BUTTON_TOOLTIP) } };
Blockly.Blocks.grove_touch = { init: function () { this.setHelpUrl(Blockly.Msg.GROVE_TOUCH_HELPURL); this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField(Blockly.Msg.GROVE_TOUCH_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.grove.touch_image, 64, 64)).appendField(Blockly.Msg.GROVE_PIN).appendField(new Blockly.FieldDropdown(profile["default"].grove_digital), "PIN"); this.setOutput(!0, "Boolean"); this.setTooltip(Blockly.Msg.GROVE_TOUCH_TOOLTIP) } };
Blockly.Blocks.grove_light_sensor = { init: function () { this.setHelpUrl(Blockly.Msg.GROVE_LIGHT_SENSOR_HELPURL); this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField(Blockly.Msg.GROVE_LIGHT_SENSOR_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.grove.light_sensor_image, 64, 64)).appendField(Blockly.Msg.GROVE_PIN).appendField(new Blockly.FieldDropdown(profile["default"].grove_analog), "PIN"); this.setOutput(!0, "Number"); this.setTooltip(Blockly.Msg.GROVE_LIGHT_SENSOR_TOOLTIP) } };
Blockly.Blocks.grove_rotary_angle = { init: function () { this.setHelpUrl(Blockly.Msg.GROVE_ROTARY_ANGLE_HELPURL); this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField(Blockly.Msg.GROVE_ROTARY_ANGLE_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.grove.rotary_angle_image, 64, 64)).appendField(Blockly.Msg.GROVE_PIN).appendField(new Blockly.FieldDropdown(profile["default"].grove_analog), "PIN"); this.setOutput(!0, "Number"); this.setTooltip(Blockly.Msg.GROVE_ROTARY_ANGLE_TOOLTIP) } };
Blockly.Blocks.grove_tilt_switch = {
    init: function () {
        this.setHelpUrl("http://www.seeedstudio.com/wiki/index.php?title=GROVE_-_Starter_Bundle_V1.0b#Tilt_switch"); this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField(Blockly.Msg.GROVE_TILT_SWITCH_TITLE).appendField(new Blockly.FieldImage("http://www.seeedstudio.com/wiki/images/thumb/9/95/Tilt1.jpg/400px-Tilt1.jpg", 64, 64)).appendField(Blockly.Msg.GROVE_PIN).appendField(new Blockly.FieldDropdown(profile["default"].grove_digital), "PIN");
        this.setOutput(!0, "Boolean"); this.setTooltip(Blockly.Msg.GROVE_TILT_SWITCH_TOOLTIP)
    }
};
Blockly.Blocks.grove_buzzer = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.GROVE_BUZZER_HELPURL); this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField(Blockly.Msg.GROVE_BUZZER_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.grove.buzzer_image, 64, 64)).appendField(Blockly.Msg.GROVE_PIN).appendField(new Blockly.FieldDropdown(profile["default"].grove_digital), "PIN").appendField(Blockly.Msg.GROVE_STAT).appendField(new Blockly.FieldDropdown([[Blockly.Msg.INOUT_HIGH, "HIGH"],
...
Blockly.Blocks.grove_relay = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.GROVE_RELAY_HELPURL); this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField(Blockly.Msg.GROVE_RELAY_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.grove.relay_image, 64, 64)).appendField(Blockly.Msg.GROVE_PIN).appendField(new Blockly.FieldDropdown(profile["default"].grove_digital), "PIN").appendField(Blockly.Msg.GROVE_STAT).appendField(new Blockly.FieldDropdown([[Blockly.Msg.INOUT_HIGH, "HIGH"], [Blockly.Msg.INOUT_LOW,
            "LOW"]]), "STAT"); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip(Blockly.Msg.GROVE_RELAY_TOOLTIP)
    }
};
Blockly.Blocks.grove_temporature_sensor = { init: function () { this.setHelpUrl(Blockly.Msg.GROVE_TEMP_SENSOR_HELPURL); this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField(Blockly.Msg.GROVE_TEMP_SENSOR_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.grove.temperature_sensor_image, 64, 64)).appendField(Blockly.Msg.GROVE_PIN).appendField(new Blockly.FieldDropdown(profile["default"].grove_analog), "PIN"); this.setOutput(!0, "Number"); this.setTooltip(Blockly.Msg.GROVE_TEMP_SENSOR_TOOLTIP) } };
...
Blockly.Blocks.grove_sound_sensor = { init: function () { this.setHelpUrl(Blockly.Msg.GROVE_SOUND_SENSOR_HELPURL); this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField(Blockly.Msg.GROVE_SOUND_SENSOR_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.grove.sound_sensor_image, 64, 64)).appendField(Blockly.Msg.GROVE_PIN).appendField(new Blockly.FieldDropdown(profile["default"].grove_analog), "PIN"); this.setOutput(!0, "Number"); this.setTooltip(Blockly.Msg.GROVE_SOUND_SENSOR_TOOLTIP) } };
Blockly.Blocks.grove_pir_motion_sensor = {
    helpUrl: "http://www.seeedstudio.com/wiki/Grove_-_PIR_Motion_Sensor", init: function () {
        this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField("PIR Motion Sensor").appendField(new Blockly.FieldImage("http://www.seeedstudio.com/wiki/images/thumb/f/fd/Twig-PIR_Motion_Sensor.jpg/400px-Twig-PIR_Motion_Sensor.jpg", 64, 64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].grove_digital), "PIN"); this.setOutput(!0, "Number");
...
Blockly.Blocks.grove_ultrasonic_ranger = {
    init: function () {
        this.setHelpUrl("http://www.seeedstudio.com/wiki/Grove_-_Ultrasonic_Ranger"); this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField("Ultrasonic Ranger").appendField(new Blockly.FieldImage("http://www.seeedstudio.com/wiki/images/thumb/b/b0/Twig_-_Ultrasonic_Ranger2.jpg/200px-Twig_-_Ultrasonic_Ranger2.jpg", 64, 64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].grove_digital), "PIN").appendField("unit").appendField(new Blockly.FieldDropdown([["cm",
...
Blockly.Blocks.grove_motor_shield = {
    init: function () {
        this.setHelpUrl("http://www.seeedstudio.com/wiki/Motor_Shield"); this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField("Motor").appendField(new Blockly.FieldImage("http://www.seeedstudio.com/wiki/images/thumb/4/4d/Smotoshield2.jpg/400px-Smotoshield2.jpg", 64, 64)).appendField(new Blockly.FieldDropdown([["Stop", "stop"], ["Forward", "forward"], ["Right", "right"], ["Left", "left"], ["Backward", "backward"]]), "DIRECTION"); this.setPreviousStatement(!0,
            null); this.setNextStatement(!0, null); this.setTooltip("Drive two brushed DC motors")
    }
};
Blockly.Blocks.grove_thumb_joystick = {
    init: function () {
        this.setHelpUrl("http://www.seeedstudio.com/wiki/Grove_-_Thumb_Joystick"); this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField("Thumb Joystick").appendField(new Blockly.FieldImage("http://www.seeedstudio.com/wiki/images/thumb/e/e0/Twig_-_Thumb_Joystick_v0.9b.jpg/200px-Twig_-_Thumb_Joystick_v0.9b.jpg", 64, 64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].grove_analog), "PIN").appendField("axis").appendField(new Blockly.FieldDropdown([["x",
...
Blockly.Blocks.grove_rgb_led = {
    init: function () {
        this.setHelpUrl("http://www.seeedstudio.com/wiki/index.php?title=Twig_-_Chainable_RGB_LED"); this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField("Chainable RGB LED").appendField(new Blockly.FieldImage("http://www.seeedstudio.com/depot/images/product/chanbalelednb1.jpg", 64, 64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].grove_digital), "PIN"); this.appendDummyInput("COLOR0").setAlign(Blockly.ALIGN_RIGHT).appendField("Color 1").appendField(new Blockly.FieldColour("#00ff00"),
    ...
    }, mutationToDom: function () { var a = document.createElement("mutation"); a.setAttribute("items", this.itemCount_); for (var b = 0; b < this.itemCount_; b++) { var d = this.getFieldValue("RGB0"); a.setAttribute("RGB" + b, d) } return a }, domToMutation: function (a) {
        ...
        var b = Blockly.Block.obtain(a,
            "grove_rgb_led_container"); b.initSvg(); for (var d = b.getInput("STACK").connection, c = 0; c < this.itemCount_; c++) { var e = Blockly.Block.obtain(a, "grove_rgb_led_item"); e.initSvg(); d.connect(e.previousConnection); d = e.nextConnection } return b
    }, compose: function (a) {
        if (0 == this.itemCount_) this.removeInput("COLOR0"); else for (var b = this.itemCount_ - 1; 0 <= b; b--)this.removeInput("COLOR" + b); this.itemCount_ = 0; for (a = a.getInputTargetBlock("STACK"); a;) {
            b = this.getFieldValue("RGB" + this.itemCount_); null == b && (b = "00ff00"); var d =
                this.appendDummyInput("COLOR" + this.itemCount_); d.setAlign(Blockly.ALIGN_RIGHT).appendField("Color " + (this.itemCount_ + 1)).appendField(new Blockly.FieldColour(b), "RGB" + this.itemCount_); a.valueConnection_ && d.connection.connect(a.valueConnection_); this.itemCount_++; a = a.nextConnection && a.nextConnection.targetBlock()
...
Blockly.Blocks.grove_rgb_lcd_begin = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.GROVE_RGB_LCD_HELPURL); this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField(Blockly.Msg.GROVE_RGB_LCD_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.grove.rgb_lcd_image, 64, 64)).appendField(Blockly.Msg.GROVE_RGB_LCD_BEGIN_TITLE).appendField(Blockly.Msg.COL).appendField(new Blockly.FieldTextInput("16"), "COLS"); this.appendDummyInput().appendField(Blockly.Msg.ROW).appendField(new Blockly.FieldTextInput("2"),
            "ROWS"); this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.GROVE_RGB_LCD_BEGIN_TOOLTIP)
    }, onchange: function () { this.workspace && this.setWarningText(Blockly.Msg.GROVE_RGB_LCD_BEGIN_WARNING) }
};
...
Blockly.Blocks.grove_rgb_lcd_setcursor = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.GROVE_RGB_LCD_HELPURL); this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField(Blockly.Msg.GROVE_RGB_LCD_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.grove.rgb_lcd_image, 64, 64)).appendField(Blockly.Msg.GROVE_RGB_LCD_SETCURSOR_TITLE).appendField(Blockly.Msg.COL).appendField(new Blockly.FieldTextInput("0"), "COL"); this.appendDummyInput().appendField(Blockly.Msg.ROW).appendField(new Blockly.FieldTextInput("0"),
            "ROW"); this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.GROVE_RGB_LCD_SETCURSOR_TOOLTIP)
...
Blockly.Blocks.grove_rgb_lcd_custom_setcursor = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.GROVE_RGB_LCD_HELPURL); this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField(Blockly.Msg.GROVE_RGB_LCD_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.grove.rgb_lcd_image, 64, 64)).appendField(Blockly.Msg.GROVE_RGB_LCD_SETCURSOR_TITLE); this.appendValueInput("COL").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.COL); this.appendValueInput("ROW").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.ROW);
        this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.GROVE_RGB_LCD_SETCURSOR_TOOLTIP)
    }, onchange: function () { this.workspace && (Blockly.Blocks.grove.rgb_lcd_checkBlocks(this) ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.GROVE_RGB_LCD_WARNING)) }
};
Blockly.Blocks.grove_rgb_lcd_clear = {
    init: function () { this.setHelpUrl(Blockly.Msg.GROVE_RGB_LCD_HELPURL); this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField(Blockly.Msg.GROVE_RGB_LCD_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.grove.rgb_lcd_image, 64, 64)).appendField(Blockly.Msg.GROVE_RGB_LCD_CLEAR_TITLE); this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.GROVE_RGB_LCD_CLEAR_TOOLTIP) }, onchange: function () {
        this.workspace &&
        (Blockly.Blocks.grove.rgb_lcd_checkBlocks(this) ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.GROVE_RGB_LCD_WARNING))
    }
};
...
Blockly.Blocks.grove_ir_receiver_init = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.GROVE_IR_RECEIVER_HELPURL); this.setColour(Blockly.Blocks.grove.HUE); this.appendDummyInput().appendField(Blockly.Msg.GROVE_IR_RECEIVER_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.grove.ir_receiver_image, 64, 64)).appendField(Blockly.Msg.GROVE_IR_RECEIVER_INIT_TITLE).appendField(Blockly.Msg.PIN).appendField(new Blockly.FieldDropdown(profile["default"].grove_digital), "PIN"); this.setInputsInline(!0); this.setPreviousStatement(!0);
        this.setNextStatement(!0); this.setTooltip(Blockly.Msg.GROVE_IR_REVEIVER_INIT_TOOLTIP)
    }, onchange: function () { this.workspace && this.setWarningText(Blockly.Msg.GROVE_IR_RECEIVER_INIT_WARNING) }
};
...
Blockly.Blocks.i2c_matrix_begin = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.I2C_MATRIX_HELPURL); this.setColour(Blockly.Blocks.i2c_matrix.HUE); this.appendDummyInput().appendField(Blockly.Msg.I2C_MATRIX_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.mini_matrix_image, 64, 64)).appendField(Blockly.Msg.I2C_MATRIX_BEGIN_TITLE).appendField(Blockly.Msg.I2C_MATRIX_TYPE).appendField(new Blockly.FieldDropdown(profile["default"].i2c_matrix_type), "TYPE").appendField(Blockly.Msg.I2C_MATRIX_ADDRESS).appendField(new Blockly.FieldDropdown(profile["default"].led_backpack_address),
            "ADDRESS"); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip("")
    }, onchange: function () { this.workspace && this.setWarningText(Blockly.Msg.I2C_MATRIX_BEGIN_WARNING) }
};
Blockly.Blocks.i2c_matrix_clear = {
    init: function () { this.setHelpUrl(Blockly.Msg.I2C_MATRIX_HELPURL); this.setColour(Blockly.Blocks.i2c_matrix.HUE); this.appendDummyInput().appendField(Blockly.Msg.I2C_MATRIX_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.mini_matrix_image, 64, 64)).appendField(Blockly.Msg.I2C_MATRIX_CLEAR); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip("") }, onchange: function () {
...
Blockly.Blocks.i2c_matrix_setcursor = {
    init: function () {
        ...
        this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip("")
...
Blockly.Blocks.i2c_matrix_settextcolor = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.I2C_MATRIX_HELPURL); this.setColour(Blockly.Blocks.i2c_matrix.HUE); this.appendDummyInput().appendField(Blockly.Msg.I2C_MATRIX_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.mini_matrix_image, 64, 64)).appendField(Blockly.Msg.I2C_MATRIX_SETTEXTCOLOR); this.appendDummyInput().appendField(Blockly.Msg.COLOR).appendField(new Blockly.FieldDropdown([[Blockly.Msg.I2C_MATRIX_LED_ON, "LED_ON"], [Blockly.Msg.I2C_MATRIX_LED_OFF,
            "LED_OFF"], [Blockly.Msg.GREEN, "LED_GREEN"], [Blockly.Msg.YELLOW, "LED_YELLOW"], [Blockly.Msg.RED, "LED_RED"]]), "COLOR"); this.setInputsInline(!0); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip("")
    }, onchange: function () { this.workspace && (Blockly.Blocks.i2c_matrix.checkBlocks(this) ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.I2C_MATRIX_WARNING)) }
};
...
Blockly.Blocks.i2c_matrix_drawline = {
    init: function () {
        ...
        this.appendValueInput("X1").setCheck("Number").appendField(Blockly.Msg.I2C_MATRIX_X1); this.appendValueInput("Y1").setCheck("Number").appendField(Blockly.Msg.I2C_MATRIX_Y1); this.appendDummyInput().appendField(Blockly.Msg.COLOR).appendField(new Blockly.FieldDropdown([[Blockly.Msg.I2C_MATRIX_LED_ON, "LED_ON"], [Blockly.Msg.I2C_MATRIX_LED_OFF, "LED_OFF"], [Blockly.Msg.GREEN, "LED_GREEN"], [Blockly.Msg.YELLOW, "LED_YELLOW"], [Blockly.Msg.RED, "LED_RED"]]), "COLOR"); this.setInputsInline(!0); this.setPreviousStatement(!0,
            null); this.setNextStatement(!0, null); this.setTooltip("")
    }, onchange: function () { this.workspace && (Blockly.Blocks.i2c_matrix.checkBlocks(this) ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.I2C_MATRIX_WARNING)) }
};
...
Blockly.Blocks.i2c_sevenseg_begin = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.I2C_SEVENSEG_HELPURL); this.setColour(Blockly.Blocks.i2c_sevenseg.HUE); this.appendDummyInput().appendField(Blockly.Msg.I2C_SEVENSEG_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.i2c_sevenseg.image, 64, 64)).appendField(Blockly.Msg.I2C_SEVENSEG_BEGIN_TITLE).appendField(Blockly.Msg.I2C_SEVENSEG_ADDRESS).appendField(new Blockly.FieldDropdown(profile["default"].led_backpack_address), "ADDRESS"); this.setPreviousStatement(!0,
            null); this.setNextStatement(!0, null); this.setTooltip("")
    }, onchange: function () { this.workspace && this.setWarningText(Blockly.Msg.I2C_SEVENSEG_BEGIN_WARNING) }
};
Blockly.Blocks.i2c_sevenseg_print = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.I2C_SEVENSEG_HELPURL); this.setColour(Blockly.Blocks.i2c_sevenseg.HUE); this.appendDummyInput().appendField(Blockly.Msg.I2C_SEVENSEG_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.i2c_sevenseg.image, 64, 64)).appendField(Blockly.Msg.I2C_SEVENSEG_PRINT); this.appendValueInput("NUM").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.I2C_SEVENSEG_NUM); this.setPreviousStatement(!0, null); this.setNextStatement(!0,
            null); this.setTooltip("")
...
Blockly.Blocks.i2c_sevenseg_writedigitnum = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.I2C_SEVENSEG_HELPURL); this.setColour(Blockly.Blocks.i2c_sevenseg.HUE); this.appendDummyInput().appendField(Blockly.Msg.I2C_SEVENSEG_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.i2c_sevenseg.image, 64, 64)).appendField(Blockly.Msg.I2C_SEVENSEG_WRITEDIGITNUM); this.appendValueInput("POSITION").setCheck("Number").appendField(Blockly.Msg.I2C_SEVENSEG_POSITION); this.appendValueInput("NUM").setCheck("Number").appendField(Blockly.Msg.I2C_SEVENSEG_NUM);
        this.appendValueInput("DOTS").setCheck("BOOLEAN").appendField(Blockly.Msg.I2C_SEVENSEG_DOTS); this.setInputsInline(!0); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip("")
    }, onchange: function () { this.workspace && (Blockly.Blocks.i2c_sevenseg.checkBlocks(this) ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.I2C_SEVENSEG_WARNING)) }
};
...
Blockly.Blocks.i2c_sevenseg_boolean = { init: function () { var a = [[Blockly.Msg.I2C_SEVENSEG_BOOLEAN_TRUE, "TRUE"], [Blockly.Msg.I2C_SEVENSEG_BOOLEAN_FALSE, "FALSE"]]; this.setColour(Blockly.Blocks.i2c_sevenseg.HUE); this.setOutput(!0, "Boolean"); this.appendDummyInput().appendField(new Blockly.FieldDropdown(a), "BOOL") }, onchange: function () { this.workspace && (Blockly.Blocks.i2c_sevenseg.checkBlocks(this) ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.I2C_SEVENSEG_WARNING)) } }; Blockly.Blocks.ifttt = {}; Blockly.Blocks.ifttt.HUE = 65; Blockly.Blocks.ifttt.image = filepath.media + "/ifttt.png";
Blockly.Blocks.ifttt_get_url = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.IFTTT_GET_URL_HELPURL); this.setColour(Blockly.Blocks.ifttt.HUE); this.appendDummyInput().appendField(Blockly.Msg.IFTTT_GET_URL_TITLE).appendField(new Blockly.FieldImage(Blockly.Blocks.ifttt.image, 64, 64)); this.appendValueInput("EVENT").setCheck("String").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.IFTTT_EVENT); this.appendValueInput("KEY").setCheck("String").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.IFTTT_KEY);
        this.appendValueInput("VALUE1").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.IFTTT_VALUE1); this.appendValueInput("VALUE2").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.IFTTT_VALUE2); this.appendValueInput("VALUE3").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.IFTTT_VALUE3); this.setOutput(!0, "String"); this.setTooltip(Blockly.Msg.IFTTT_GET_URL_TOOLTIP)
    }
}; Blockly.Blocks.initializes = {}; Blockly.Blocks.initializes.HUE = 0; Blockly.Blocks.initializes_setup = { init: function () { this.setHelpUrl(Blockly.Msg.INITIALIZES_SETUP_HELPURL); this.setColour(Blockly.Blocks.initializes.HUE); this.appendDummyInput().appendField(Blockly.Msg.INITIALIZES_SETUP_APPENDTEXT); this.appendStatementInput("CONTENT"); this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.INITIALIZES_SETUP_TOOLTIP) } }; Blockly.Blocks.inout = {}; Blockly.Blocks.inout.HUE = 230; Blockly.Blocks.inout_buildin_led = { init: function () { this.setHelpUrl("http://arduino.cc/en/Reference/DigitalWrite"); this.setColour(Blockly.Blocks.inout.HUE); this.appendDummyInput().appendField("Build-in LED Stat").appendField(new Blockly.FieldDropdown([[Blockly.Msg.INOUT_HIGH, "HIGH"], [Blockly.Msg.INOUT_LOW, "LOW"]]), "STAT"); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip("light or off the build-in LED") } };
...
Blockly.Blocks.inout_digital_read = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.INOUT_DIGITAL_READ_HELPURL); this.setColour(Blockly.Blocks.inout.HUE); this.appendDummyInput().appendField(Blockly.Msg.INOUT_DIGITAL_READ_APPENDTEXT_PIN).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN"); this.appendDummyInput().appendField(Blockly.Msg.INOUT_DIGITAL_READ_APPENDTEXT_PULLUP); this.appendDummyInput().appendField(new Blockly.FieldDropdown([[Blockly.Msg.INOUT_OFF, "INPUT"], [Blockly.Msg.INOUT_ON,
            "INPUT_PULLUP"]]), "INPUT_MODE"); this.setInputsInline(!0); this.setOutput(!0, "Boolean"); this.setTooltip(Blockly.Msg.INOUT_DIGITAL_READ_TOOLTIP)
    }
};
...
Blockly.Blocks.custom_tone = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.INOUT_TONE_HELPURL); this.setColour(Blockly.Blocks.inout.HUE); this.appendDummyInput().appendField(Blockly.Msg.INOUT_TONE_APPENDTEXT_PIN).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN"); this.appendValueInput("FREQ").setCheck("Number").appendField(Blockly.Msg.INOUT_TONE_APPENDTEXT_FREQ); this.appendDummyInput().appendField(Blockly.Msg.INOUT_TONE_APPENDTEXT_DURATION).appendField(new Blockly.FieldTextInput("300"), "DURATION");
        this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.INOUT_TONE_TOOLTIP)
    }
};
Blockly.Blocks.tone = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.INOUT_TONE_HELPURL); this.setColour(Blockly.Blocks.inout.HUE); this.appendDummyInput().appendField(Blockly.Msg.INOUT_TONE_APPENDTEXT_PIN).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN"); this.appendDummyInput().appendField(Blockly.Msg.INOUT_TONE_APPENDTEXT_FREQ).appendField(new Blockly.FieldDropdown(profile["default"].tone), "FREQ"); this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0);
...
Blockly.Blocks.inout_analogpin = { init: function () { this.setHelpUrl(""); this.setColour(Blockly.Blocks.inout.HUE); this.appendDummyInput().appendField(Blockly.Msg.INOUT_ANALOGPIN_TEXT).appendField(new Blockly.FieldDropdown(profile["default"].analog), "PIN"); this.setOutput(!0, "Number"); this.setTooltip("") } }; Blockly.Blocks.interrupts = {}; Blockly.Blocks.interrupts.HUE = 190;
Blockly.Blocks.interrupts_attach = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.INTERRUPTS_ATTACH_HELPURL); this.setColour(190); this.appendDummyInput().appendField(Blockly.Msg.INTERRUPTS_ATTACH_TITLE); this.appendDummyInput().appendField(Blockly.Msg.PIN).appendField(new Blockly.FieldDropdown(profile["default"].interrupt), "PIN"); this.appendDummyInput().appendField(Blockly.Msg.MODE).appendField(new Blockly.FieldDropdown([[Blockly.Msg.LOW, "LOW"], [Blockly.Msg.CHANGE, "CHANGE"], [Blockly.Msg.RISING, "RISING"],
        [Blockly.Msg.FALLING, "FALLING"]]), "MODE"); this.appendStatementInput("CONTENT"); this.setInputsInline(!0); this.setTooltip(Blockly.Msg.INTERRUPTS_ATTACH_TOOLTIP)
    }
};
Blockly.Blocks.interrupts_detach = { init: function () { this.setHelpUrl(Blockly.Msg.INTERRUPTS_DETACH_HELPURL); this.setColour(190); this.appendDummyInput().appendField(Blockly.Msg.INTERRUPTS_DETACH_TITLE); this.appendDummyInput().appendField(new Blockly.FieldDropdown(profile["default"].interrupt), "PIN"); this.setInputsInline(!0); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip(Blockly.Msg.INTERRUPTS_DETACH_TOOLTIP) } };
Blockly.Blocks.interrupts = { init: function () { this.setHelpUrl(Blockly.Msg.INTERRUPTS_HELPURL); this.setColour(190); this.appendDummyInput().appendField(Blockly.Msg.INTERRUPTS_TITLE); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip(Blockly.Msg.INTERRUPTS_TOOLTIP) } };
Blockly.Blocks.interrupts_no = { init: function () { this.setHelpUrl(Blockly.Msg.INTERRUPTS_NO_HELPURL); this.setColour(190); this.appendDummyInput().appendField(Blockly.Msg.INTERRUPTS_NO_TITLE); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip(Blockly.Msg.INTERRUPTS_NO_TOOLTIP) } }; Blockly.Blocks.involt = {}; Blockly.Blocks.involt.HUE = 65; Blockly.Blocks.involt_directmode = { init: function () { this.setHelpUrl("http://www.example.com/"); this.setColour(Blockly.Blocks.involt.HUE); this.appendDummyInput().appendField("directMode"); this.appendDummyInput().appendField(new Blockly.FieldDropdown([["true", "TRUE"], ["false", "FALSE"]]), "BOOL"); this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip("") } };
...
Blockly.Blocks.lcd_begin = {
    init: function () {
        ...
        this.setNextStatement(!0); this.setTooltip(Blockly.Msg.LCD_BEGIN_TOOLTIP)
    }
...
Blockly.Blocks.lcd_setcursor = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.LCD_SETCURSOR_HELPURL); this.setColour(Blockly.Blocks.lcd.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.lcd.image, 64, 64)).appendField(Blockly.Msg.LCD_SETCURSOR_TITLE).appendField(Blockly.Msg.COL).appendField(new Blockly.FieldTextInput("0"), "COL"); this.appendDummyInput().appendField(Blockly.Msg.ROW).appendField(new Blockly.FieldTextInput("0"), "ROW"); this.setInputsInline(!0); this.setPreviousStatement(!0);
...
Blockly.Blocks.controls_if = {
    init: function () {
        ...
        a = a.getInputTargetBlock("STACK"); for (var b = 1; a;) {
            switch (a.type) {
                case "controls_if_elseif": var d = this.getInput("IF" + b), c = this.getInput("DO" + b); a.valueConnection_ = d && d.connection.targetConnection; a.statementConnection_ = c && c.connection.targetConnection;
                    b++; break; case "controls_if_else": c = this.getInput("ELSE"); a.statementConnection_ = c && c.connection.targetConnection; break; default: throw "Unknown block type.";
            }a = a.nextConnection && a.nextConnection.targetBlock()
        }
    }
...
Blockly.Blocks.logic_compare = {
    init: function () {
        var a = Blockly.RTL ? [["=", "EQ"], ["\u2260", "NEQ"], [">", "LT"], ["\u2265", "LTE"], ["<", "GT"], ["\u2264", "GTE"]] : [["=", "EQ"], ["\u2260", "NEQ"], ["<", "LT"], ["\u2264", "LTE"], [">", "GT"], ["\u2265", "GTE"]]; this.setHelpUrl(Blockly.Msg.LOGIC_COMPARE_HELPURL); this.setColour(Blockly.Blocks.logic.HUE); this.setOutput(!0, "Boolean"); this.appendValueInput("A"); this.appendValueInput("B").appendField(new Blockly.FieldDropdown(a), "OP"); this.setInputsInline(!0); var b = this; this.setTooltip(function () {
            var a =
        ...
        if (this.workspace) {
            var a = this.getInputTargetBlock("A"), b = this.getInputTargetBlock("B"); if (a && b && !a.outputConnection.checkType_(b.outputConnection)) for (var d = 0; d < this.prevBlocks_.length; d++) {
                var c =
                    this.prevBlocks_[d]; if (c === a || c === b) c.setParent(null), c.bumpNeighbours_()
...
Blockly.Blocks.logic_ternary = { init: function () { this.setHelpUrl(Blockly.Msg.LOGIC_TERNARY_HELPURL); this.setColour(Blockly.Blocks.logic.HUE); this.appendValueInput("IF").setCheck("Boolean").appendField(Blockly.Msg.LOGIC_TERNARY_CONDITION); this.appendValueInput("THEN").appendField(Blockly.Msg.LOGIC_TERNARY_IF_TRUE); this.appendValueInput("ELSE").appendField(Blockly.Msg.LOGIC_TERNARY_IF_FALSE); this.setOutput(!0); this.setTooltip(Blockly.Msg.LOGIC_TERNARY_TOOLTIP) } }; Blockly.Blocks.loops = {}; Blockly.Blocks.loops.HUE = 120;
...
Blockly.Blocks.controls_for = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.CONTROLS_FOR_HELPURL); this.setColour(Blockly.Blocks.loops.HUE); this.appendDummyInput().appendField(Blockly.Msg.CONTROLS_FOR_INPUT_WITH).appendField(new Blockly.FieldVariable(null), "VAR"); this.interpolateMsg(Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO, ["FROM", "Number", Blockly.ALIGN_RIGHT], ["TO", "Number", Blockly.ALIGN_RIGHT], Blockly.ALIGN_RIGHT); this.appendStatementInput("DO").appendField(Blockly.Msg.CONTROLS_FOR_INPUT_DO); this.setPreviousStatement(!0);
        this.setNextStatement(!0); this.setInputsInline(!0); var a = this; this.setTooltip(function () { return Blockly.Msg.CONTROLS_FOR_TOOLTIP.replace("%1", a.getFieldValue("VAR")) })
        ...
        if (!this.isCollapsed()) {
            var b = { enabled: !0 }, d = this.getFieldValue("VAR"); b.text = Blockly.Msg.VARIABLES_SET_CREATE_GET.replace("%1", d); d = goog.dom.createDom("field",
                null, d); d.setAttribute("name", "VAR"); d = goog.dom.createDom("block", null, d); d.setAttribute("type", "variables_get"); b.callback = Blockly.ContextMenu.callbackFactory(this, d); a.push(b)
        }
    }
};
Blockly.Blocks.controls_forEach = {
    init: function () {
        ...
        this.appendStatementInput("DO").appendField(Blockly.Msg.CONTROLS_FOREACH_INPUT_DO); this.setPreviousStatement(!0); this.setNextStatement(!0); var a = this; this.setTooltip(function () { return Blockly.Msg.CONTROLS_FOREACH_TOOLTIP.replace("%1", a.getFieldValue("VAR")) })
...
Blockly.Blocks.m2x_custom_list_value = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.M2X_HELPURL); this.setColour(Blockly.Blocks.m2x.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.m2x.image, 64, 64)).appendField(Blockly.Msg.M2X_LIST_VALUE_TITLE); this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.M2X_DATE0_TITLE).appendField(new Blockly.FieldDate("2000-01-01"), "DATE0").appendField(new Blockly.FieldTextInput("00"), "HOUR0").appendField(":").appendField(new Blockly.FieldTextInput("00"),
...
Blockly.Blocks.m2x_delete_values = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.M2X_HELPURL); this.setColour(Blockly.Blocks.m2x.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.m2x.image, 64, 64)).appendField(Blockly.Msg.M2X_DELETE_VALUES_TITLE); this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.M2X_DATE0_TITLE).appendField(new Blockly.FieldDate("2000-01-01"), "DATE0").appendField(new Blockly.FieldTextInput("00"), "HOUR0").appendField(":").appendField(new Blockly.FieldTextInput("00"),
            "MIN0").appendField(":").appendField(new Blockly.FieldTextInput("00"), "SEC0"); this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.M2X_DATE1_TITLE).appendField(new Blockly.FieldDate("2000-01-01"), "DATE1").appendField(new Blockly.FieldTextInput("01"), "HOUR1").appendField(":").appendField(new Blockly.FieldTextInput("00"), "MIN1").appendField(":").appendField(new Blockly.FieldTextInput("00"), "SEC1"); this.setOutput(!0, "Number"); this.setTooltip(Blockly.Msg.M2X_DELETE_VALUES_TOOLTIP)
    }
};
Blockly.Blocks.m2x_update_location = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.M2X_HELPURL); this.setColour(Blockly.Blocks.m2x.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.m2x.image, 64, 64)).appendField(Blockly.Msg.M2X_UPDATE_LOCATION_TITLE); this.appendValueInput("LOCATION_NAME").setCheck("String").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.M2X_LOCATION_NAME); this.appendValueInput("LATITUDE").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.LATITUDE);
...
Blockly.Blocks.math_arithmetic = {
    init: function () {
        var a = [[Blockly.Msg.MATH_ADDITION_SYMBOL, "ADD"], [Blockly.Msg.MATH_SUBTRACTION_SYMBOL, "MINUS"], [Blockly.Msg.MATH_MULTIPLICATION_SYMBOL, "MULTIPLY"], [Blockly.Msg.MATH_DIVISION_SYMBOL, "DIVIDE"], [Blockly.Msg.MATH_MODULO_SYMBOL, "MODULO"], [Blockly.Msg.MATH_POWER_SYMBOL, "POWER"]]; this.setHelpUrl(Blockly.Msg.MATH_ARITHMETIC_HELPURL); this.setColour(Blockly.Blocks.math.HUE); this.setOutput(!0, "Number"); this.appendValueInput("A").setCheck("Number"); this.appendValueInput("B").setCheck("Number").appendField(new Blockly.FieldDropdown(a),
...
Blockly.Blocks.math_random_max_min = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.MATH_RANDOM_MAX_MIN_HELPURL); this.setColour(Blockly.Blocks.math.HUE); this.appendDummyInput().appendField(Blockly.Msg.MATH_RANDOM_MAX_MIN_APPENDTEXT_RANDOM); this.appendValueInput("MAX").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.MATH_RANDOM_MAX_MIN_APPENDTEXT_MAX); this.appendValueInput("MIN").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.MATH_RANDOM_MAX_MIN_APPENDTEXT_MIN);
...
Blockly.Blocks.mpr121_reset = { init: function () { this.setHelpUrl(Blockly.Msg.MPR121_HELPURL); this.setColour(Blockly.Blocks.mpr121.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.mpr121.image, 64, 64)).appendField(Blockly.Msg.MPR121_RESET_TITLE); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip(Blockly.Msg.MPR121_RESET_TOOLTIP) }, onchange: function () { this.workspace && (Blockly.Blocks.mpr121.checkBlocks(this) ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.MPR121_WARNING)) } }; Blockly.Blocks.neopixel = {}; Blockly.Blocks.neopixel.HUE = 215; Blockly.Blocks.neopixel.image = filepath.media + "/neopixel.jpg"; Blockly.Blocks.neopixel.checkBlocks = function (a) { var b = null, d = a.type; a = a.workspace.getAllBlocks(); for (var c = 0; c < a.length; c++)if ("neopixel_setpixelcolor" != a[c].type && "neopixel_custom_setpixelcolor" != a[c].type && "neopixel_show" != a[c].type && "neopixel_setpixelcolor2" != a[c].type || null != b || (b = a[c].type != d ? !0 : !1), "neopixel_begin" == a[c].type) return !0; return b };
Blockly.Blocks.neopixel_begin = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.NEOPIXEL_BEGIN_HELPURL); this.setColour(Blockly.Blocks.neopixel.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.neopixel.image, 64, 64)).appendField(Blockly.Msg.NEOPIXEL_BEGIN_SETTING).appendField(Blockly.Msg.NEOPIXEL_BEGIN_NUM).appendField(new Blockly.FieldTextInput("16"), "NUM"); this.appendDummyInput().appendField(Blockly.Msg.NEOPIXEL_BEGIN_PIN).appendField(new Blockly.FieldDropdown(profile["default"].digital),
            "PIN"); this.appendDummyInput().appendField(Blockly.Msg.NEOPIXEL_BEGIN_BRIGHTNESS).appendField(new Blockly.FieldTextInput("50"), "BRIGHTNESS"); this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.NEOPIXEL_BEGIN_TOOLTIP)
    }, onchange: function () { this.workspace && this.setWarningText(Blockly.Msg.NEOPIXEL_BEGIN_WARNING) }
};
Blockly.Blocks.neopixel_setpixelcolor = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.NEOPIXEL_CUSTOM_SETPIXELCOLOR_HELPURL); this.setColour(Blockly.Blocks.neopixel.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.neopixel.image, 64, 64)); this.appendValueInput("TARGET").setCheck("Number").appendField(Blockly.Msg.NEOPIXEL_CUSTOM_SETPIXELCOLOR_TARGET); this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.COLOR).appendField(new Blockly.FieldColour("#00ff00"),
            "RGB"); this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.NEOPIXEL_CUSTOM_SETPIXELCOLOR_TOOLTIP)
    }, onchange: function () { this.workspace && (Blockly.Blocks.neopixel.checkBlocks(this) ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.NEOPIXEL_WARNING)) }
};
Blockly.Blocks.neopixel_custom_setpixelcolor = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.NEOPIXEL_CUSTOM_SETPIXELCOLOR_HELPURL); this.setColour(Blockly.Blocks.neopixel.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.neopixel.image, 64, 64)); this.appendValueInput("TARGET").setCheck("Number").appendField(Blockly.Msg.NEOPIXEL_CUSTOM_SETPIXELCOLOR_TARGET); this.appendValueInput("R").setCheck("Number").appendField(Blockly.Msg.NEOPIXEL_CUSTOM_SETPIXELCOLOR_R); this.appendValueInput("G").setCheck("Number").appendField(Blockly.Msg.NEOPIXEL_CUSTOM_SETPIXELCOLOR_G);
        this.appendValueInput("B").setCheck("Number").appendField(Blockly.Msg.NEOPIXEL_CUSTOM_SETPIXELCOLOR_B); this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.NEOPIXEL_CUSTOM_SETPIXELCOLOR_TOOLTIP)
    }, onchange: function () { this.workspace && (Blockly.Blocks.neopixel.checkBlocks(this) ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.NEOPIXEL_WARNING)) }
};
Blockly.Blocks.neopixel_show = {
    init: function () { this.setHelpUrl(Blockly.Msg.NEOPIXEL_SHOW_HELPURL); this.setColour(Blockly.Blocks.neopixel.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.neopixel.image, 64, 64)).appendField(Blockly.Msg.NEOPIXEL_SHOW); this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.NEOPIXEL_SHOW_TOOLTIP) }, onchange: function () {
...
Blockly.Blocks.procedures_defnoreturn = {
    init: function () {
        ...
        for (var a = document.createElement("mutation"), b = 0; b < this.arguments_.length; b++) { var d = document.createElement("arg"); d.setAttribute("name", this.arguments_[b]); a.appendChild(d) } this.hasStatements_ ||
            a.setAttribute("statements", "false"); return a
    }, domToMutation: function (a) { this.arguments_ = []; for (var b = 0, d; d = a.childNodes[b]; b++)"arg" == d.nodeName.toLowerCase() && this.arguments_.push(d.getAttribute("name")); this.updateParams_(); this.setStatements_("false" !== a.getAttribute("statements")) }, decompose: function (a) {
    ...
    renameVar: function (a, b) { for (var d = !1, c = 0; c < this.arguments_.length; c++)Blockly.Names.equals(a, this.arguments_[c]) && (this.arguments_[c] = b, d = !0); if (d && (this.updateParams_(), this.mutator.isVisible())) for (var d = this.mutator.workspace_.getAllBlocks(), c = 0, e; e = d[c]; c++)"procedures_mutatorarg" == e.type && Blockly.Names.equals(a, e.getFieldValue("NAME")) && e.setFieldValue(b, "NAME") }, customContextMenu: function (a) {
        var b = { enabled: !0 }, d = this.getFieldValue("NAME"); b.text = Blockly.Msg.PROCEDURES_CREATE_DO.replace("%1",
            d); var c = goog.dom.createDom("mutation"); c.setAttribute("name", d); for (var e = 0; e < this.arguments_.length; e++)d = goog.dom.createDom("arg"), d.setAttribute("name", this.arguments_[e]), c.appendChild(d); c = goog.dom.createDom("block", null, c); c.setAttribute("type", this.callType_); b.callback = Blockly.ContextMenu.callbackFactory(this, c); a.push(b); if (!this.isCollapsed()) for (e = 0; e < this.arguments_.length; e++)b = { enabled: !0 }, d = this.arguments_[e], b.text = Blockly.Msg.VARIABLES_SET_CREATE_GET.replace("%1", d), c = goog.dom.createDom("field",
    ...
    init: function () { this.setHelpUrl(Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL); this.setColour(Blockly.Blocks.procedures.HUE); this.appendDummyInput("TOPROW").appendField(Blockly.Msg.PROCEDURES_CALLNORETURN_CALL).appendField("", "NAME"); this.setPreviousStatement(!0); this.setNextStatement(!0); this.arguments_ = []; this.quarkArguments_ = this.quarkConnections_ = null }, getProcedureCall: function () { return this.getFieldValue("NAME") }, renameProcedure: function (a, b) {
        ...
        if (b) if (goog.array.equals(this.arguments_, a)) this.quarkArguments_ = b; else {
            this.setCollapsed(!1); if (b.length != a.length) throw "Error: paramNames and paramIds must be the same length."; this.quarkArguments_ || (this.quarkConnections_ = {}, a.join("\n") == this.arguments_.join("\n") ?
                this.quarkArguments_ = b : this.quarkArguments_ = []); var d = this.rendered; this.rendered = !1; for (var c = this.arguments_.length - 1; 0 <= c; c--) { var e = this.getInput("ARG" + c); if (e) { var f = e.connection.targetConnection; this.quarkConnections_[this.quarkArguments_[c]] = f; this.removeInput("ARG" + c) } } this.arguments_ = [].concat(a); this.quarkArguments_ = b; for (c = 0; c < this.arguments_.length; c++) {
                    e = this.appendValueInput("ARG" + c).setAlign(Blockly.ALIGN_RIGHT).appendField(this.arguments_[c]); if (this.quarkArguments_) {
                ...
                } if (e = this.getInput("TOPROW")) this.arguments_.length ? this.getField_("WITH") || (e.appendField(Blockly.Msg.PROCEDURES_CALL_BEFORE_PARAMS, "WITH"), e.init()) : this.getField_("WITH") && e.removeField("WITH"); (this.rendered = d) && this.render()
        } else this.quarkConnections_ = {}, this.quarkArguments_ = null
    }, mutationToDom: function () {
        var a =
            document.createElement("mutation"); a.setAttribute("name", this.getProcedureCall()); for (var b = 0; b < this.arguments_.length; b++) { var d = document.createElement("arg"); d.setAttribute("name", this.arguments_[b]); a.appendChild(d) } return a
    }, domToMutation: function (a) {
        var b = a.getAttribute("name"); this.setFieldValue(b, "NAME"); this.setTooltip((this.outputConnection ? Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP : Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP).replace("%1", b)); if ((b = Blockly.Procedures.getDefinition(b, this.workspace)) &&
            b.mutator && b.mutator.isVisible()) this.setProcedureParameters(b.arguments_, b.paramIds_); else { for (var b = [], d = 0, c; c = a.childNodes[d]; d++)"arg" == c.nodeName.toLowerCase() && b.push(c.getAttribute("name")); this.setProcedureParameters(b, b) }
    }, renameVar: function (a, b) { for (var d = 0; d < this.arguments_.length; d++)Blockly.Names.equals(a, this.arguments_[d]) && (this.arguments_[d] = b, this.getInput("ARG" + d).fieldRow[0].setText(b)) }, customContextMenu: function (a) {
        var b = { enabled: !0 }; b.text = Blockly.Msg.PROCEDURES_HIGHLIGHT_DEF;
        var d = this.getProcedureCall(), c = this.workspace; b.callback = function () { var a = Blockly.Procedures.getDefinition(d, c); a && a.select() }; a.push(b)
    }
...
Blockly.Blocks.rgbled_begin = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.RGBLED_BEGIN_HELPURL); this.setColour(Blockly.Blocks.rgbled.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.rgbled.image, 64, 64)).appendField(Blockly.Msg.RGBLED_BEGIN_SETTING).appendField(Blockly.Msg.RGBLED_BEGIN_NUM).appendField(new Blockly.FieldTextInput("16"), "NUM"); this.appendDummyInput().appendField(Blockly.Msg.RGBLED_BEGIN_PIN).appendField(new Blockly.FieldDropdown(profile["default"].digital),
            "PIN"); this.appendDummyInput().appendField(Blockly.Msg.RGBLED_BEGIN_BRIGHTNESS).appendField(new Blockly.FieldTextInput("50"), "BRIGHTNESS"); this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.RGBLED_BEGIN_TOOLTIP)
    }, onchange: function () { this.workspace && this.setWarningText(Blockly.Msg.RGBLED_BEGIN_WARNING) }
};
Blockly.Blocks.rgbled_setpixelcolor = {
    init: function () {
        ...
        this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.RGBLED_SETPIXELCOLOR_TOOLTIP)
    }, onchange: function () { this.workspace && (Blockly.Blocks.rgbled.checkBlocks(this) ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.RGBLED_WARNING)) }
};
Blockly.Blocks.rgbled_setpixelcolor2 = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.RGBLED_CUSTOM_SETPIXELCOLOR_HELPURL); this.setColour(Blockly.Blocks.rgbled.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.rgbled.image, 64, 64)); this.appendValueInput("TARGET").setCheck("Number").appendField(Blockly.Msg.RGBLED_CUSTOM_SETPIXELCOLOR_TARGET); this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.COLOR).appendField(new Blockly.FieldColour("#00ff00"), "RGB");
        this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.RGBLED_CUSTOM_SETPIXELCOLOR_TOOLTIP)
    }, onchange: function () { this.workspace && (Blockly.Blocks.rgbled.checkBlocks(this) ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.RGBLED_WARNING)) }
};
Blockly.Blocks.rgbled_custom_setpixelcolor = {
    init: function () {
        ...
        this.appendValueInput("B").setCheck("Number").appendField(Blockly.Msg.RGBLED_CUSTOM_SETPIXELCOLOR_B); this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.RGBLED_CUSTOM_SETPIXELCOLOR_TOOLTIP)
    }, onchange: function () { this.workspace && (Blockly.Blocks.rgbled.checkBlocks(this) ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.RGBLED_WARNING)) }
};
Blockly.Blocks.rgbled_show = {
    init: function () { this.setHelpUrl(Blockly.Msg.RGBLED_SHOW_HELPURL); this.setColour(Blockly.Blocks.rgbled.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.rgbled.image, 64, 64)).appendField(Blockly.Msg.RGBLED_SHOW); this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.RGBLED_SHOW_TOOLTIP) }, onchange: function () {
...
}; Blockly.Blocks.serial = {}; Blockly.Blocks.serial.HUE = 200; Blockly.Blocks.serial_print = { init: function () { this.setHelpUrl(Blockly.Msg.SERIAL_PRINT_HELPURL); this.setColour(Blockly.Blocks.serial.HUE); this.appendValueInput("CONTENT").setCheck(["Number", "String"]).appendField(Blockly.Msg.SERIAL_PRINT_APPENDTEXT); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip(Blockly.Msg.SERIAL_PRINT_TOOLTIP) } };
...
Blockly.Blocks.serial_println = { init: function () { this.setHelpUrl(Blockly.Msg.SERIAL_PRINTLN_HELPURL); this.setColour(Blockly.Blocks.serial.HUE); this.appendValueInput("CONTENT").setCheck(["Number", "String"]).appendField(Blockly.Msg.SERIAL_PRINTLN_APPENDTEXT); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.SERIAL_PRINTLN_TOOLTIP) } }; Blockly.Blocks.servo = {}; Blockly.Blocks.servo.HUE = 215; Blockly.Blocks.servo.image = filepath.media + "/servo.jpg";
Blockly.Blocks.servo_attach = { init: function () { this.setHelpUrl(Blockly.Msg.SERVO_ATTACH_HELPURL); this.setColour(Blockly.Blocks.servo.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.servo.image, 64, 64)).appendField(Blockly.Msg.SERVO_ATTACH_TEXT1).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN").appendField(Blockly.Msg.SERVO_ATTACH_TEXT2); this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.SERVO_ATTACH_TOOLTIP) } };
Blockly.Blocks.servo_custom_attach = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.SERVO_ATTACH_HELPURL); this.setColour(Blockly.Blocks.servo.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.servo.image, 64, 64)).appendField(Blockly.Msg.SERVO_ATTACH_TEXT1).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN").appendField(Blockly.Msg.SERVO_ATTACH_TEXT2); this.appendDummyInput().appendField(Blockly.Msg.SERVO_ATTACH_MAX_TEXT1).appendField(new Blockly.FieldTextInput("2400"),
            "MAX").appendField(Blockly.Msg.SERVO_ATTACH_MAX_TEXT2); this.appendDummyInput().appendField(Blockly.Msg.SERVO_ATTACH_MIN_TEXT1).appendField(new Blockly.FieldTextInput("544"), "MIN").appendField(Blockly.Msg.SERVO_ATTACH_MIN_TEXT2); this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.SERVO_ATTACH_TOOLTIP)
    }
};
Blockly.Blocks.servo_write = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.SERVO_WRITE_HELPURL); this.setColour(Blockly.Blocks.servo.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.servo.image, 64, 64)).appendField(Blockly.Msg.SERVO_WRITE_TEXT1).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN").appendField(Blockly.Msg.SERVO_WRITE_TEXT2); this.appendValueInput("ANGLE").setCheck("Number").appendField(Blockly.Msg.SERVO_ANGLE_TEXT1); this.appendDummyInput().appendField(Blockly.Msg.SERVO_ANGLE_TEXT2);
        this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.SERVO_WRITE_TOOLTIP)
    }
};
Blockly.Blocks.servo_writeus = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.SERVO_WRITE_US_HELPURL); this.setColour(Blockly.Blocks.servo.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.servo.image, 64, 64)).appendField(Blockly.Msg.SERVO_WRITE_TEXT1).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN").appendField(Blockly.Msg.SERVO_WRITE_TEXT2); this.appendValueInput("ANGLE_US").setCheck("Number").appendField(Blockly.Msg.SERVO_ANGLE_US_TEXT1); this.appendDummyInput().appendField(Blockly.Msg.SERVO_ANGLE_US_TEXT2);
        this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.SERVO_WRITE_US_TOOLTIP)
    }
};
...
Blockly.Blocks.servo_attached = { init: function () { this.setHelpUrl(Blockly.Msg.SERVO_ATTACHED_HELPURL); this.setColour(Blockly.Blocks.servo.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.servo.image, 64, 64)).appendField(Blockly.Msg.SERVO_ATTACHED_TEXT1).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN").appendField(Blockly.Msg.SERVO_ATTACHED_TEXT2); this.setInputsInline(!0); this.setOutput(!0, "Boolean"); this.setTooltip(Blockly.Msg.SERVO_ATTACHED_TOOLTIP) } };
Blockly.Blocks.servo_detach = { init: function () { this.setHelpUrl(Blockly.Msg.SERVO_DETACH_HELPURL); this.setColour(Blockly.Blocks.servo.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.servo.image, 64, 64)).appendField(Blockly.Msg.SERVO_DETACH_TEXT1).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN").appendField(Blockly.Msg.SERVO_DETACH_TEXT2); this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.SERVO_DETACH_TOOLTIP) } }; Blockly.Blocks.shield_bot = {}; Blockly.Blocks.shield_bot.HUE = 190; Blockly.Blocks.shield_bot.image = filepath.media + "/shield_bot.jpg";
Blockly.Blocks.shield_bot.checkBlocks = function (a) {
    var b = !1, d = a.type; a = a.workspace.getAllBlocks(); for (var c = 0; c < a.length; c++)if ("shield_bot_setmaxspeed" == a[c].type || "shield_bot_setmaxspeed_lr" == a[c].type || "shield_bot_right_motor" == a[c].type || "shield_bot_motor" == a[c].type || "shield_bot_drive" == a[c].type || "shield_bot_faststop" == a[c].type || "shield_bot_faststop_left" == a[c].type || "shield_bot_faststop_right" == a[c].type || "shield_bot_move" == a[c].type || "shield_bot_readsensor" == a[c].type) {
        a[c].type != d && (b = !0);
        break
    } return b
};
Blockly.Blocks.shield_bot_setmaxspeed = {
    init: function () { this.setHelpUrl(Blockly.Msg.SHIELD_BOT_HELPURL); this.setColour(Blockly.Blocks.shield_bot.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.shield_bot.image, 64, 64)).appendField(Blockly.Msg.SHIELD_BOT_SETMAXSPEED_TITLE).appendField(new Blockly.FieldTextInput("255"), "SPEED"); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip(Blockly.Msg.SHIELD_BOT_SETMAXSPEED_TOOLTIP) }, onchange: function () {
...
Blockly.Blocks.shield_bot_setmaxspeed_lr = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.SHIELD_BOT_HELPURL); this.setColour(Blockly.Blocks.shield_bot.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.shield_bot.image, 64, 64)).appendField(Blockly.Msg.SHIELD_BOT_SETMAXSPEED_TITLE).appendField(Blockly.Msg.SHIELD_BOT_LEFT_SPEED).appendField(new Blockly.FieldTextInput("255"), "LEFT").appendField(Blockly.Msg.SHIELD_BOT_RIGHT_SPEED).appendField(new Blockly.FieldTextInput("255"), "RIGHT");
        this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip(Blockly.Msg.SHIELD_BOT_SETMAXSPEED_LR_TOOLTIP)
...
Blockly.Blocks.shield_bot_motor = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.SHIELD_BOT_HELPURL); this.setColour(Blockly.Blocks.shield_bot.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.shield_bot.image, 64, 64)).appendField(Blockly.Msg.SHIELD_BOT_CONTROL).appendField(new Blockly.FieldDropdown([[Blockly.Msg.RIGHT, "rightMotor"], [Blockly.Msg.LEFT, "leftMotor"]]), "RL"); this.appendValueInput("DIRECTION").appendField(Blockly.Msg.SHIELD_BOT_MOTOR).setCheck("Number").appendField(Blockly.Msg.DIRECTION);
        this.setInputsInline(!0); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip(Blockly.Msg.SHIELD_BOT_LEFT_MOTOR_TOOLTIP)
    }, onchange: function () { this.workspace && (Blockly.Blocks.shield_bot.checkBlocks(this) ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.SHEILD_BOT_WARNING)) }
};
Blockly.Blocks.shield_bot_drive = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.SHIELD_BOT_HELPURL); this.setColour(Blockly.Blocks.shield_bot.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.shield_bot.image, 64, 64)).appendField(Blockly.Msg.SHIELD_BOT_DRIVE_TITLE); this.appendValueInput("LEFT").setCheck("Number").appendField(Blockly.Msg.LEFT); this.appendValueInput("RIGHT").setCheck("Number").appendField(Blockly.Msg.RIGHT); this.setInputsInline(!0); this.setPreviousStatement(!0,
            null); this.setNextStatement(!0, null); this.setTooltip(Blockly.Msg.SHIELD_BOT_DRIVE_TOOLTIP)
    }, onchange: function () { this.workspace && (Blockly.Blocks.shield_bot.checkBlocks(this) ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.SHEILD_BOT_WARNING)) }
};
Blockly.Blocks.shield_bot_faststop = {
    init: function () { this.setHelpUrl(Blockly.Msg.SHIELD_BOT_HELPURL); this.setColour(Blockly.Blocks.shield_bot.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.shield_bot.image, 64, 64)).appendField(Blockly.Msg.SHIELD_BOT_faststop_TITLE); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip(Blockly.Msg.SHIELD_BOT_FASTSTOP_TOOLTIP) }, onchange: function () {
        this.workspace && (Blockly.Blocks.shield_bot.checkBlocks(this) ?
            this.setWarningText(null) : this.setWarningText(Blockly.Msg.SHEILD_BOT_WARNING))
    }
};
Blockly.Blocks.shield_bot_faststop_left = {
    init: function () { this.setHelpUrl(Blockly.Msg.SHIELD_BOT_HELPURL); this.setColour(Blockly.Blocks.shield_bot.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.shield_bot.image, 64, 64)).appendField(Blockly.Msg.SHIELD_BOT_FASTSTOP_LEFT_TITLE); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip(Blockly.Msg.SHIELD_BOT_FASTSTOP_LEFT_TOOLTIP) }, onchange: function () {
        this.workspace && (Blockly.Blocks.shield_bot.checkBlocks(this) ?
            this.setWarningText(null) : this.setWarningText(Blockly.Msg.SHEILD_BOT_WARNING))
    }
};
Blockly.Blocks.shield_bot_faststop_right = {
    init: function () { this.setHelpUrl(Blockly.Msg.SHIELD_BOT_HELPURL); this.setColour(Blockly.Blocks.shield_bot.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.shield_bot.image, 64, 64)).appendField(Blockly.Msg.SHIELD_BOT_FASTSTOP_RIGHT_TITLE); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip(Blockly.Msg.SHIELD_BOT_FASTSTOP_RIGHT_TOOLTIP) }, onchange: function () {
        this.workspace && (Blockly.Blocks.shield_bot.checkBlocks(this) ?
            this.setWarningText(null) : this.setWarningText(Blockly.Msg.SHEILD_BOT_WARNING))
    }
};
Blockly.Blocks.shield_bot_move = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.SHIELD_BOT_HELPURL); this.setColour(Blockly.Blocks.shield_bot.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.shield_bot.image, 64, 64)).appendField(Blockly.Msg.SHIELD_BOT_MOVE_TITLE).appendField(new Blockly.FieldDropdown([[Blockly.Msg.SHIELD_BOT_FORWARD, "forward"], [Blockly.Msg.SHIELD_BOT_BACKWARD, "backward"], [Blockly.Msg.SHIELD_BOT_STOP, "stop"], [Blockly.Msg.SHIELD_BOT_STOPLEFT, "stopLeft"], [Blockly.Msg.SHIELD_BOT_STOPRIGHT,
            "stopRight"]]), "MOVE"); this.setPreviousStatement(!0, null); this.setNextStatement(!0, null); this.setTooltip(Blockly.Msg.SHIELD_BOT_MOVE_TOOLTIP)
    }, onchange: function () { this.workspace && (Blockly.Blocks.shield_bot.checkBlocks(this) ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.SHEILD_BOT_WARNING)) }
};
Blockly.Blocks.shield_bot_readsensor = {
    init: function () { this.setHelpUrl(Blockly.Msg.SHIELD_BOT_HELPURL); this.setColour(Blockly.Blocks.shield_bot.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.shield_bot.image, 64, 64)).appendField(Blockly.Msg.SHIELD_BOT_READ_SENSOR_TITLE).appendField(Blockly.Msg.INDEX).appendField(new Blockly.FieldDropdown(profile["default"].shield_bot_sensor), "SENSOR"); this.setOutput(!0); this.setTooltip(Blockly.Msg.SHIELD_BOT_READ_SENSOR_TOOLTIP) }, onchange: function () {
        this.workspace &&
...
Blockly.Blocks.text_join = {
    init: function () { this.setHelpUrl(Blockly.Msg.TEXT_JOIN_HELPURL); this.setColour(Blockly.Blocks.texts.HUE); this.itemCount_ = 2; this.updateShape_(); this.setOutput(!0, "String"); this.setMutator(new Blockly.Mutator(["text_create_join_item"])); this.setTooltip(Blockly.Msg.TEXT_JOIN_TOOLTIP) }, mutationToDom: function () { var a = document.createElement("mutation"); a.setAttribute("items", this.itemCount_); return a }, domToMutation: function (a) {
        ...
        this.updateShape_()
    }, decompose: function (a) { var b = Blockly.Block.obtain(a, "text_create_join_container"); b.initSvg(); for (var d = b.getInput("STACK").connection, c = 0; c < this.itemCount_; c++) { var e = Blockly.Block.obtain(a, "text_create_join_item"); e.initSvg(); d.connect(e.previousConnection); d = e.nextConnection } return b }, compose: function (a) {
        a = a.getInputTargetBlock("STACK"); for (var b = [], d = 0; a;)b[d] = a.valueConnection_, a = a.nextConnection && a.nextConnection.targetBlock(), d++; this.itemCount_ = d; this.updateShape_(); for (d =
            0; d < this.itemCount_; d++)b[d] && this.getInput("ADD" + d).connection.connect(b[d])
    }, saveConnections: function (a) { a = a.getInputTargetBlock("STACK"); for (var b = 0; a;) { var d = this.getInput("ADD" + b); a.valueConnection_ = d && d.connection.targetConnection; b++; a = a.nextConnection && a.nextConnection.targetBlock() } }, updateShape_: function () {
        if (this.getInput("EMPTY")) this.removeInput("EMPTY"); else for (var a = 0; this.getInput("ADD" + a);)this.removeInput("ADD" + a), a++; if (0 == this.itemCount_) this.appendDummyInput("EMPTY").appendField(new Blockly.FieldImage(Blockly.pathToMedia +
...
Blockly.Blocks.millis = { init: function () { this.setHelpUrl(Blockly.Msg.TIMES_MILLIS_HELPURL); this.setColour(Blockly.Blocks.times.HUE); this.appendDummyInput().appendField(Blockly.Msg.TIMES_MILLIS_APPENDTEXT); this.setOutput(!0, "Number"); this.setTooltip(Blockly.Msg.TIMES_MILLIS_TOOLTIP) } }; Blockly.Blocks.ultrasonic = {}; Blockly.Blocks.ultrasonic.HUE = 215; Blockly.Blocks.ultrasonic.image = filepath.media + "/ultrasonic.jpg";
Blockly.Blocks.ultrasonic_setting = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.ULTRASONIC_SETTING_HELPURL); this.setColour(Blockly.Blocks.ultrasonic.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.ultrasonic.image, 64, 64)).appendField(Blockly.Msg.ULTRASONIC_SETTING_TITLE); this.appendDummyInput().appendField(Blockly.Msg.ULTRASONIC_SETTING_TRIG); this.appendDummyInput().appendField(new Blockly.FieldDropdown(profile["default"].digital), "TRIG"); this.appendDummyInput().appendField(Blockly.Msg.ULTRASONIC_SETTING_ECHO);
        this.appendDummyInput().appendField(new Blockly.FieldDropdown(profile["default"].digital), "ECHO"); this.appendDummyInput().appendField(Blockly.Msg.ULTRASONIC_SETTING_RESET); this.appendDummyInput().appendField(new Blockly.FieldDropdown(profile["default"].digital), "RESET"); this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0); this.setTooltip(Blockly.Msg.ULTRASONIC_SETTING_TOOLTIP)
    }
};
Blockly.Blocks.ultrasonic_maxrange = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.ULTRASONIC_MAXRANGE_HELPURL); this.setColour(Blockly.Blocks.ultrasonic.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.ultrasonic.image, 64, 64)).appendField(Blockly.Msg.ULTRASONIC_MAXRANGE_TITLE).appendField(new Blockly.FieldTextInput("20"), "MAXRANGE").appendField(new Blockly.FieldDropdown([["cm", "CM"], ["inch", "INCH"]]), "UNIT"); this.setInputsInline(!0); this.setPreviousStatement(!0); this.setNextStatement(!0);
        this.setTooltip(Blockly.Msg.ULTRASONIC_MAXRANGE_TOOLTIP)
    }
};
Blockly.Blocks.ultrasonic_distance = { init: function () { this.setHelpUrl(Blockly.Msg.ULTRASONIC_DISTANCE_HELPURL); this.setColour(Blockly.Blocks.ultrasonic.HUE); this.appendDummyInput().appendField(new Blockly.FieldImage(Blockly.Blocks.ultrasonic.image, 64, 64)).appendField(Blockly.Msg.ULTRASONIC_MAXRANGE_TITLE); this.appendDummyInput().appendField(new Blockly.FieldDropdown([["cm", "CM"], ["inch", "INCH"]]), "UNIT"); this.setInputsInline(!0); this.setOutput(!0, "Number"); this.setTooltip(Blockly.Msg.ULTRASONIC_MAXRANGE_TOOLTIP) } }; Blockly.Blocks.variables = {}; Blockly.Blocks.variables.HUE = 330;
Blockly.Blocks.variables_get = {
    init: function () {
        this.setHelpUrl(Blockly.Msg.VARIABLES_GET_HELPURL); this.setColour(Blockly.Blocks.variables.HUE); this.appendDummyInput().appendField(Blockly.Msg.VARIABLES_GET_TITLE).appendField(new Blockly.FieldDropdown(Blockly.Variables.allTypes(), this.typeChangedHandler), "TYPE").appendField(new Blockly.FieldVariable(Blockly.Msg.VARIABLES_GET_ITEM), "VAR").appendField(Blockly.Msg.VARIABLES_GET_TAIL); this.setOutput(!0); this.setTooltip(Blockly.Msg.VARIABLES_GET_TOOLTIP);
        this.contextMenuMsg_ = Blockly.Msg.VARIABLES_GET_CREATE_SET; this.contextMenuType_ = "variables_set"
    }, postInit: function () { var a = this.getFieldValue("VAR"); (a = Blockly.Variables.typeOf(a, Blockly.mainWorkspace)) && this.setType(a) }, getVars: function () { return [this.getFieldValue("VAR")] }, typeOf: function (a) { if (Blockly.Names.equals(a, this.getFieldValue("VAR"))) return this.getFieldValue("TYPE") }, changeType: function (a, b) { Blockly.Names.equals(a, this.getFieldValue("VAR")) && this.setType(b) }, setType: function (a) {
        var b =
            this.outputConnection.targetConnection; b && !b.acceptsType(a) && this.unplug(); this.setFieldValue(a, "TYPE"); this.changeOutput(a)
    }, renameVar: function (a, b) { Blockly.Names.equals(a, this.getFieldValue("VAR")) && this.setFieldValue(b, "VAR") }, customContextMenu: function (a) {
        var b = { enabled: !0 }, d = this.getFieldValue("VAR"); b.text = this.contextMenuMsg_.replace("%1", d); d = goog.dom.createDom("field", null, d); d.setAttribute("name", "VAR"); d = goog.dom.createDom("block", null, d); d.setAttribute("type", this.contextMenuType_); b.callback =
            Blockly.ContextMenu.callbackFactory(this, d); a.push(b)
    }, typeChangedHandler: function (a) { var b = this.sourceBlock_.getFieldValue("VAR"); Blockly.Variables.changeType(b, a, Blockly.mainWorkspace) }, nameChangedHandler: function (a) { var b = this.sourceBlock_; (a = Blockly.Variables.typeOf(a, Blockly.mainWorkspace)) && b.setType(a) }
};
Blockly.Blocks.variables_set = {
    init: function () {
        ...
        this.setNextStatement(!0); this.setTooltip(Blockly.Msg.VARIABLES_SET_TOOLTIP); this.contextMenuMsg_ = Blockly.Msg.VARIABLES_SET_CREATE_GET; this.contextMenuType_ = "variables_get"
    }, postInit: function () { var a = this.getFieldValue("VAR"); (a = Blockly.Variables.typeOf(a, Blockly.mainWorkspace)) && this.setType(a) }, getVars: function () { return [this.getFieldValue("VAR")] }, setType: function (a) { this.setFieldValue(a, "TYPE"); this.getInput("VALUE").setCheck(a) }, renameVar: function (a, b) {
        Blockly.Names.equals(a, this.getFieldValue("VAR")) &&
        this.setFieldValue(b, "VAR")
    }, typeOf: Blockly.Blocks.variables_get.typeOf, changeType: Blockly.Blocks.variables_get.changeType, customContextMenu: Blockly.Blocks.variables_get.customContextMenu, typeChangedHandler: Blockly.Blocks.variables_get.typeChangedHandler, nameChangedHandler: Blockly.Blocks.variables_get.nameChangedHandler
};
